...
:root[data-theme="dark"] .card h1,:root[data-theme="dark"] .card h2,:root[data-theme="dark"] .card h3,:root[data-theme="dark"] .card h4,:root[data-theme="dark"] .card b,:root[data-theme="dark"] .card strong,:root[data-theme="dark"] .card p,:root[data-theme="dark"] .hotel-title{color:var(--text)!important}
...
:root[data-theme="dark"] [style*="background:#fff"],:root[data-theme="dark"] [style*="background: #fff"],:root[data-theme="dark"] [style*="background:white"],:root[data-theme="dark"] [style*="background: white"],:root[data-theme="dark"] [style*="background:#f8fafb"],:root[data-theme="dark"] [style*="background: #f8fafb"],:root[data-theme="dark"] [style*="background:#fff8"],:root[data-theme="dark"] [style*="background: #fff8"]{background:var(--card)!important;color:var(--text)!important}
:root[data-theme="dark"] [style*="color:#17313b"],:root[data-theme="dark"] [style*="color: #17313b"],:root[data-theme="dark"] [style*="color:#667983"],:root[data-theme="dark"] [style*="color: #667983"],:root[data-theme="dark"] [style*="color:#27434d"],:root[data-theme="dark"] [style*="color: #27434d"]{color:var(--text)!important}
...
#themeToggleBtn{position:fixed!important;left:10px!important;top:10px!important;right:auto!important;z-index:10000!important;width:38px!important;height:38px!important;min-width:38px!important;max-width:38px!important;padding:0!important;margin:0!important;border:1px solid #ffffff66!important;background:#0b2730!important;color:#fff!important;border-radius:9px!important;font-size:18px!important;line-height:36px!important;font-weight:400!important;display:flex!important;align-items:center!important;justify-content:center!important;box-shadow:0 2px 8px #0005!important;white-space:nowrap!important;overflow:hidden!important}
@media(max-width:850px){#themeToggleBtn{left:8px!important;top:8px!important;width:34px!important;height:34px!important;min-width:34px!important;max-width:34px!important;font-size:16px!important;line-height:32px!important}}
`;document.head.appendChild(s)}
function addButton(){if(document.getElementById('themeToggleBtn'))return;const b=document.createElement('button');b.id='themeToggleBtn';b.type='button';b.onclick=()=>apply(currentTheme()==='dark'?'light':'dark',true);document.body.appendChild(b);apply(currentTheme(),false)}
