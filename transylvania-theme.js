...
:root[data-theme="light"] body,:root[data-theme="light"] main,:root[data-theme="light"] .wrap,:root[data-theme="light"] .page{background:var(--bg)!important;color:var(--text)!important}
:root[data-theme="light"] section:not(.dash-hero){color:var(--text)!important}
:root[data-theme="light"] .card,:root[data-theme="light"] .edit-day,:root[data-theme="light"] .attraction-row,:root[data-theme="light"] .metric,:root[data-theme="light"] .facts div,:root[data-theme="light"] .summary-row,:root[data-theme="light"] .expense-item,:root[data-theme="light"] .summary-note,:root[data-theme="light"] .bike-options,:root[data-theme="light"] .bike-option,:root[data-theme="light"] .home-item,:root[data-theme="light"] .emergency-card,:root[data-theme="light"] .home-smart-card,:root[data-theme="light"] .home-quick,:root[data-theme="light"] .dash-card{background:var(--card)!important;color:var(--text)!important;border-color:var(--line)!important}
:root[data-theme="light"] .muted,:root[data-theme="light"] .source{color:var(--muted)!important}
:root[data-theme="light"] .btn,:root[data-theme="light"] .home-smart-actions a,:root[data-theme="light"] .home-smart-actions button,:root[data-theme="light"] #nextNavFab,:root[data-theme="light"] .dash-primary{background:var(--p)!important;color:#fff!important}
...
/* Dashboard hero must stay dark in light mode for readable white text */
:root[data-theme="light"] #page-home .dash-hero{background:linear-gradient(135deg,#31473A 0%,#24362C 100%)!important;color:#FFF9F1!important;border-color:transparent!important}
:root[data-theme="light"] #page-home .dash-hero h1,:root[data-theme="light"] #page-home .dash-hero b{color:#FFFDF8!important}
:root[data-theme="light"] #page-home .dash-hero p,:root[data-theme="light"] #page-home .dash-hero .dash-stat span{color:#E6E0D6!important}
:root[data-theme="light"] #page-home .dash-hero .dash-eyebrow{color:#E8C887!important}
:root[data-theme="light"] #page-home .dash-hero .dash-stat{background:#FFFFFF12!important;border-color:#FFFFFF35!important;color:#fff!important}
:root[data-theme="light"] #page-home .dash-progress{background:#FFFFFF25!important}
:root[data-theme="light"] #page-home .dash-progress i{background:#D0A765!important}
...
html,body{width:100%!important;max-width:100%!important;overflow-x:hidden!important}body *{max-width:100%;min-width:0}.wrap,main.wrap,.page,section,.card,.home-grid,.grid,.facts,.metrics,.controls,.rate-cards,.summary-row,.expense-form,.expense-item,.calc-grid,.route-editor,.edit-day,#homeSmartPanel{min-width:0!important;max-width:100%!important}img,svg,canvas,video,iframe{max-width:100%!important;height:auto}#map{max-width:100%!important}pre,code,.ltr,.phone{max-width:100%!important;overflow-wrap:anywhere}
@media(max-width:850px){header .head{width:100%!important;max-width:100%!important;grid-template-columns:1fr!important;padding:7px 8px!important;overflow:visible!important}.brand-row{width:100%!important}header .brand{max-width:100%!important;white-space:normal!important}header .nav{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;width:100%!important;max-width:100%!important;overflow:visible!important;gap:5px!important;padding:2px 0!important}header .nav button,#themeToggleBtn{width:100%!important;max-width:none!important;min-width:0!important;flex:none!important;height:auto!important;min-height:34px!important;padding:6px 4px!important;font-size:11px!important;line-height:1.15!important;white-space:normal!important;text-align:center!important}#themeToggleBtn{display:flex!important;align-items:center!important;justify-content:center!important}.wrap{padding-left:10px!important;padding-right:10px!important;width:100%!important}.grid,.metrics,.controls,.facts,.rate-cards,.home-grid,.calc-grid,.summary-row,.expense-form,.expense-item{grid-template-columns:1fr!important;width:100%!important}.card{width:100%!important;padding:13px!important}.home-quick-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.more-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.tabs{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;overflow:visible!important;width:100%!important}.tab{min-width:0!important;white-space:normal!important;padding:8px 4px!important;font-size:12px!important}.hotel-title{display:grid!important;grid-template-columns:1fr!important}.price{font-size:1.3rem!important;overflow-wrap:anywhere}}
@media(max-width:430px){header .nav{grid-template-columns:repeat(3,minmax(0,1fr))!important}.tabs{grid-template-columns:repeat(3,minmax(0,1fr))!important}.home-quick-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}}
`;
