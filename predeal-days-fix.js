...
function apply(){
  ...
  D[1]={n:'ראשון · פרדיאל',note:'',s:[['Hotel Orizont Predeal',45.503,25.578,'','מלון']]};
  D[2]={n:'שני · פרדיאל · יום כיפור',note:'יום כיפור — נשארים במלון.',s:[['Hotel Orizont Predeal',45.503,25.578,'','נשארים במלון · יום כיפור']]};
