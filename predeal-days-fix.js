...
function apply(){
  ...
  D[3]={n:'שלישי · Predeal → Bran Plaza',note:'המסלול שבוצע בפועל ב-22.9. Bran Plaza היה היעד היחיד היום.',s:[['Hotel Orizont Predeal',45.503,25.578,'יציאה','יציאה מהמלון'],['BRAN PLAZA',45.55,25.32,'אחר כך','Bran Plaza · בוצע ✅'],['Hotel Orizont Predeal',45.503,25.578,'חזרה','חזרה למלון · בוצע ✅']]};
